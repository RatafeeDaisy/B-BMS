	...
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"margin":"0 0 30px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"100%","float":"left","justifyContent":"flex-start"}' class="input" v-else-if="ruleForm.yudingdanhao" label="预订单号" prop="yudingdanhao">
					<el-input v-model="ruleForm.yudingdanhao" placeholder="预订单号" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"margin":"0 0 30px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"100%","float":"left","justifyContent":"flex-start"}' class="input" v-if="type!='info'"  label="房间类型" prop="fangjianleixing">
				...
				<el-form-item :style='{"margin":"0 0 30px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"100%","float":"left","justifyContent":"flex-start"}' class="date" v-if="type!='info'" label="预定日期" prop="yudingriqi">
					<el-date-picker
				...
				<el-form-item :style='{"margin":"0 0 30px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"100%","float":"left","justifyContent":"flex-start"}' class="input" v-else-if="ruleForm.yudingriqi" label="预定日期" prop="yudingriqi">
					<el-input v-model="ruleForm.yudingriqi" placeholder="预定日期" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 30px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"100%","float":"left","justifyContent":"flex-start"}' class="date" v-if="type!='info'" label="入住时间" prop="ruzhushijian">
					<el-date-picker
				...
				<el-form-item :style='{"margin":"0 0 30px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"100%","float":"left","justifyContent":"flex-start"}' class="input" v-else-if="ruleForm.ruzhushijian" label="入住时间" prop="ruzhushijian">
				...
				<el-form-item :style='{"margin":"0 0 30px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"100%","float":"left","justifyContent":"flex-start"}' class="input" v-if="type!='info'"  label="会员折扣" prop="huiyuanzhekou">
					<el-input v-model="ruleForm.huiyuanzhekou" placeholder="会员折扣" clearable  :readonly="ro.huiyuanzhekou"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 30px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"100%","float":"left","justifyContent":"flex-start"}' v-else class="input" label="会员折扣" prop="huiyuanzhekou">
					<el-input v-model="ruleForm.huiyuanzhekou" placeholder="会员折扣" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"margin":"0 0 30px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"100%","float":"left","justifyContent":"flex-start"}' class="input" v-else-if="ruleForm.dingdanjine" label="订单金额" prop="dingdanjine">
				...
				<el-form-item :style='{"margin":"0 0 30px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"100%","float":"left","justifyContent":"flex-start"}' class="input" v-if="type!='info'"  label="会员类型" prop="huiyuanleixing">
					<el-input v-model="ruleForm.huiyuanleixing" placeholder="会员类型" clearable  :readonly="ro.huiyuanleixing"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 30px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"100%","float":"left","justifyContent":"flex-start"}' v-else class="input" label="会员类型" prop="huiyuanleixing">
					<el-input v-model="ruleForm.huiyuanleixing" placeholder="会员类型" readonly></el-input>
				</el-form-item>
			</template>
		...
		init(id,type) {
			...
			this.$http({
				...
				if (data && data.code === 0) {
					...
					if(((json.huiyuanzhekou!=''&&json.huiyuanzhekou) || json.huiyuanzhekou==0) && this.$storage.get("role")!="管理员"){
					...
					if(((json.huiyuanleixing!=''&&json.huiyuanleixing) || json.huiyuanleixing==0) && this.$storage.get("role")!="管理员"){

	...
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"margin":"0 0 30px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"100%","float":"left","justifyContent":"flex-start"}' class="input" v-if="type!='info'"  label="房间楼层" prop="fangjianlouceng">
					<el-input v-model="ruleForm.fangjianlouceng" placeholder="房间楼层" clearable  :readonly="ro.fangjianlouceng"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 30px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"100%","float":"left","justifyContent":"flex-start"}' v-else class="input" label="房间楼层" prop="fangjianlouceng">
					<el-input v-model="ruleForm.fangjianlouceng" placeholder="房间楼层" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 30px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"100%","float":"left","justifyContent":"flex-start"}' class="select" v-if="type!='info'"  label="房间类型" prop="fangjianleixing">
				...
				<el-form-item :style='{"margin":"0 0 30px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"100%","float":"left","justifyContent":"flex-start"}' v-else class="input" label="房间类型" prop="fangjianleixing">
				...
				<el-form-item :style='{"margin":"0 0 30px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"100%","float":"left","justifyContent":"flex-start"}' class="input" v-if="type!='info'"  label="房间设施" prop="fangjiansheshi">
					<el-input v-model="ruleForm.fangjiansheshi" placeholder="房间设施" clearable  :readonly="ro.fangjiansheshi"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 30px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"100%","float":"left","justifyContent":"flex-start"}' v-else class="input" label="房间设施" prop="fangjiansheshi">
					<el-input v-model="ruleForm.fangjiansheshi" placeholder="房间设施" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 30px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"100%","float":"left","justifyContent":"flex-start"}' class="input" v-if="type!='info'"  label="房间价格" prop="fangjianjiage">
					<el-input v-model="ruleForm.fangjianjiage" placeholder="房间价格" clearable  :readonly="ro.fangjianjiage"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 30px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"100%","float":"left","justifyContent":"flex-start"}' v-else class="input" label="房间价格" prop="fangjianjiage">
					<el-input v-model="ruleForm.fangjianjiage" placeholder="房间价格" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 30px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"100%","float":"left","justifyContent":"flex-start"}' class="select" v-if="type!='info'"  label="房间状态" prop="fangjianzhuangtai">
				...
				<el-form-item :style='{"margin":"0 0 30px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"100%","float":"left","justifyContent":"flex-start"}' v-else class="input" label="房间状态" prop="fangjianzhuangtai">
					<el-input v-model="ruleForm.fangjianzhuangtai"
						placeholder="房间状态" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 30px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"100%","float":"left","justifyContent":"flex-start"}' class="input" v-if="type!='info'"  label="服务特色" prop="fuwutese">
					<el-input v-model="ruleForm.fuwutese" placeholder="服务特色" clearable  :readonly="ro.fuwutese"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 30px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"100%","float":"left","justifyContent":"flex-start"}' v-else class="input" label="服务特色" prop="fuwutese">
					<el-input v-model="ruleForm.fuwutese" placeholder="服务特色" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 30px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"100%","float":"left","justifyContent":"flex-start"}' class="input" v-if="type!='info'"  label="订房电话" prop="dingfangdianhua">
					<el-input v-model="ruleForm.dingfangdianhua" placeholder="订房电话" clearable  :readonly="ro.dingfangdianhua"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 30px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"100%","float":"left","justifyContent":"flex-start"}' v-else class="input" label="订房电话" prop="dingfangdianhua">
					<el-input v-model="ruleForm.dingfangdianhua" placeholder="订房电话" readonly></el-input>
				</el-form-item>
			</template>
				<el-form-item :style='{"margin":"0 0 30px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"100%","float":"left","justifyContent":"flex-start"}' v-if="type!='info'"  label="房间介绍" prop="fangjianjieshao">
					<editor 
				...
				<el-form-item :style='{"margin":"0 0 30px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"100%","float":"left","justifyContent":"flex-start"}' v-else-if="ruleForm.fangjianjieshao" label="房间介绍" prop="fangjianjieshao">
                    <span :style='{"fontSize":"14px","lineHeight":"40px","color":"#fff","fontWeight":"500","display":"inline-block"}' v-html="ruleForm.fangjianjieshao"></span>
                </el-form-item>
...
export default {
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.fangjianjieshao = this.ruleForm.fangjianjieshao.replace(reg,'../../../B_BMS/upload');
        } else {
          this.$message.error(data.msg);
        }
      });

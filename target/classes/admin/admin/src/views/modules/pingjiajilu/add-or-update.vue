<template>
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"margin":"0 0 30px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"100%","float":"left","justifyContent":"flex-start"}' class="input" v-if="type!='info'" label="退房单号" prop="tuifangdanhao">
					<el-input v-model="ruleForm.tuifangdanhao" placeholder="退房单号" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 30px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"100%","float":"left","justifyContent":"flex-start"}' class="input" v-else-if="ruleForm.tuifangdanhao" label="退房单号" prop="tuifangdanhao">
					<el-input v-model="ruleForm.tuifangdanhao" placeholder="退房单号" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"margin":"0 0 30px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"100%","float":"left","justifyContent":"flex-start"}' class="date" v-if="type!='info'" label="退房时间" prop="tuifangshijian">
					<el-date-picker
				...
				<el-form-item :style='{"margin":"0 0 30px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"100%","float":"left","justifyContent":"flex-start"}' class="input" v-else-if="ruleForm.tuifangshijian" label="退房时间" prop="tuifangshijian">
					<el-input v-model="ruleForm.tuifangshijian" placeholder="退房时间" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 30px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"100%","float":"left","justifyContent":"flex-start"}' class="input" v-if="type!='info'"  label="退房备注" prop="tuifangbeizhu">
					<el-input v-model="ruleForm.tuifangbeizhu" placeholder="退房备注" clearable  :readonly="ro.tuifangbeizhu"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 30px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"100%","float":"left","justifyContent":"flex-start"}' v-else class="input" label="退房备注" prop="tuifangbeizhu">
					<el-input v-model="ruleForm.tuifangbeizhu" placeholder="退房备注" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 30px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"100%","float":"left","justifyContent":"flex-start"}' class="select" v-if="type!='info'"  label="房间评分" prop="fangjianpingfen">
				...
				<el-form-item :style='{"margin":"0 0 30px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"100%","float":"left","justifyContent":"flex-start"}' v-else class="input" label="房间评分" prop="fangjianpingfen">
				...
				<el-form-item :style='{"margin":"0 0 30px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"100%","float":"left","justifyContent":"flex-start"}' class="textarea" v-if="type!='info'" label="评价内容" prop="pingjianeirong">
					<el-input
				...
				<el-form-item :style='{"margin":"0 0 30px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"100%","float":"left","justifyContent":"flex-start"}' v-else-if="ruleForm.pingjianeirong" label="评价内容" prop="pingjianeirong">
					<span :style='{"fontSize":"14px","lineHeight":"40px","color":"#fff","fontWeight":"500","display":"inline-block"}'>{{ruleForm.pingjianeirong}}</span>
				</el-form-item>

	...
	methods: {
		...
		styleChange() {
			this.$nextTick(() => {
				  ...
				  const icon = {"border":"none","width":"180px","margin":"8px auto 0 auto","background":"none","display":"none"}
	...
	.menu-preview {
	  .el-scrollbar {
		...
		.el-menu-vertical-demo>.el-menu-item {
				  				  ...
				  				  color: #ddd;
				  				  white-space: nowrap;
				  				  background: url(http://codegen.caihongy.cn/20221201/087851d2f1774276ad9c3e7f0c94506e.png) no-repeat;
				  				  width: 100%;
				  				  line-height: 86px;
				  				  position: relative;
				  				  text-align: center;

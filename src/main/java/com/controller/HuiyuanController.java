...
public class HuiyuanController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
		HuiyuanEntity u = huiyuanService.selectOne(new EntityWrapper<HuiyuanEntity>().eq("yonghuming", username));
    ...
    public R register(@RequestBody HuiyuanEntity huiyuan){
    	...
    	HuiyuanEntity u = huiyuanService.selectOne(new EntityWrapper<HuiyuanEntity>().eq("yonghuming", huiyuan.getYonghuming()));
		if(u!=null) {

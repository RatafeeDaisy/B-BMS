    ...
    <el-tabs tab-position="left" :style='{"width":"100%","flexWrap":"wrap","background":"none","justifyContent":"center","display":"flex"}' @tab-click="handleClick">
      <el-tab-pane label="个人中心">
        <el-form class="center-preview-pv" ref="sessionForm" :model="sessionForm" :rules="rules" label-width="110px">
          <el-form-item :style='{"width":"100%","padding":"0 0 20px 0","boxShadow":"0 2px 0 #efe4d4","margin":"0 0 10px","background":"none"}' v-if="userTableName=='huiyuan'" label="用户名" prop="yonghuming">
            <el-input v-model="sessionForm.yonghuming" placeholder="用户名" readonly></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"100%","padding":"0 0 20px 0","boxShadow":"0 2px 0 #efe4d4","margin":"0 0 10px","background":"none"}' v-if="userTableName=='huiyuan'" label="密码" prop="mima">
            <el-input type="password" v-model="sessionForm.mima" placeholder="密码"></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"100%","padding":"0 0 20px 0","boxShadow":"0 2px 0 #efe4d4","margin":"0 0 10px","background":"none"}' v-if="userTableName=='huiyuan'" label="姓名" prop="xingming">
            <el-input v-model="sessionForm.xingming" placeholder="姓名" ></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"100%","padding":"0 0 20px 0","boxShadow":"0 2px 0 #efe4d4","margin":"0 0 10px","background":"none"}' v-if="userTableName=='huiyuan'" label="性别">
            <el-select v-model="sessionForm.xingbie" placeholder="请选择性别" >
              <el-option v-for="(item, index) in dynamicProp.xingbie" :key="index" :label="item" :value="item"></el-option>
            </el-select>
          </el-form-item>
          <el-form-item :style='{"width":"100%","padding":"0 0 20px 0","boxShadow":"0 2px 0 #efe4d4","margin":"0 0 10px","background":"none"}' v-if="userTableName=='huiyuan'" label="头像">
            <el-upload
          ...
          <el-form-item :style='{"width":"100%","padding":"0 0 20px 0","boxShadow":"0 2px 0 #efe4d4","margin":"0 0 10px","background":"none"}' v-if="userTableName=='huiyuan'" label="手机" prop="shouji">
            <el-input v-model="sessionForm.shouji" placeholder="手机" ></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"100%","padding":"0 0 20px 0","boxShadow":"0 2px 0 #efe4d4","margin":"0 0 10px","background":"none"}' v-if="userTableName=='huiyuan'" label="身份证" prop="shenfenzheng">
            <el-input v-model="sessionForm.shenfenzheng" placeholder="身份证" ></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"100%","padding":"0 0 20px 0","boxShadow":"0 2px 0 #efe4d4","margin":"0 0 10px","background":"none"}' v-if="userTableName=='huiyuan'" label="会员类型">
            <el-select v-model="sessionForm.huiyuanleixing" placeholder="请选择会员类型" @change="huiyuanleixingChange" disabled>
              <el-option v-for="(item, index) in dynamicProp.huiyuanleixing" :key="index" :label="item" :value="item"></el-option>
            </el-select>
          </el-form-item>
          <el-form-item :style='{"width":"100%","padding":"0 0 20px 0","boxShadow":"0 2px 0 #efe4d4","margin":"0 0 10px","background":"none"}' v-if="userTableName=='huiyuan'" label="会员折扣" prop="huiyuanzhekou">
            <el-input v-model="sessionForm.huiyuanzhekou" placeholder="会员折扣" readonly></el-input>
          </el-form-item>
...
<script>
  ...
  export default {
    ...
    created() {
      ...
      if ('huiyuan' == this.userTableName) {
        this.$set(this.sessionForm, 'huiyuanleixing', null);
      }
      if ('huiyuan' == this.userTableName) {
        this.$set(this.sessionForm, 'huiyuanzhekou', null);
      }
      ...
      if ('huiyuan' == this.userTableName) {
        ...
        this.$set(this.rules, 'shenfenzheng', [{ required: false, validator: this.$validate.isIdCard, trigger: 'blur' }]);
			...
			if ('huiyuan' == this.userTableName) {
        this.$set(this.rules, 'huiyuanzhekou', [{ required: false, validator: this.$validate.isNumber, trigger: 'blur' }]);
      }
      ...
      init() {
        if ('huiyuan' == this.userTableName) {
          this.dynamicProp.xingbie = '男,女'.split(',');
				...
				if ('huiyuan' == this.userTableName) {
          this.$http.get('option/huiyuanleixing/huiyuanleixing', {emulateJSON: true}).then(res => {
            if (res.data.code == 0) {
              this.dynamicProp.huiyuanleixing = res.data.data;
            }
          });
        }    
      },
      huiyuanleixingChange(value) {
        this.$http.get('follow/huiyuanleixing/huiyuanleixing', {params: {columnValue: value}}).then(res => {
          if (res.data.code == 0) {
            this.sessionForm.huiyuanzhekou = res.data.data.huiyuanzhekou;
          }
        });
      },
      getSession() {
